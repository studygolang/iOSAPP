...
struct Logger {
    ...
    fileprivate static func printLog<T>(_ value: T, title: String, functionName: String, fileName: String, lineNumber: Int) {
        
        guard StarDebug else {
            // relese 不打印
            return
        }
         print("<\(current_time())> [\(title)][\((fileName as NSString).lastPathComponent):\(lineNumber)] \(value)")
    }
    
    static func info<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: InfoTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
    
    static func debug<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: DebugTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
    
    static func warning<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {

        printLog(value, title: WarningTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
    
    static func error<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: ErrorTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
    
    static func important<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: ImportantTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
...
extension Logger {
    ...
    static func success<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: SuccessTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
    
    static func failure<T>(_ value: T, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: FailureTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    }
}
...
extension Logger {
     static func assertionFailure(_ value: String, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: AssertTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
    ...
    static func fatalError(_ value: String, functionName: String = #function, fileName: String = #file, lineNumber: Int = #line) {
        printLog(value, title: FatalErrorTitle, functionName: functionName, fileName: fileName, lineNumber: lineNumber)
