...
class SGBaseController: UIViewController {
    ...
    lazy var titleLabel: UILabel = {
        let l1 = UILabel.init(frame: CGRect.init(x: 100, y: 30, width: 200, height: 40))
        l1.backgroundColor = UIColor.clear
        l1.textColor = SGTextColor1
        l1.textAlignment = NSTextAlignment.center
        l1.font = UIFont.systemFont(ofSize: 15.0)
        self.navigationItem.titleView = l1
         return l1
    }()
